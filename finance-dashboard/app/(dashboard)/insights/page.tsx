      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">
            Personalized narrative analysis generated by Gemini 2.5/3.6 Flash.
          </p>
        </div>

        {/* Period Selector */}
        <div className="flex bg-muted/10 border border-border p-1 rounded-xl self-start sm:self-auto">
